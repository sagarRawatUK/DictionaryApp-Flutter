        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: TextFormField(
                  controller:
                      BlocProvider.of<DictionaryCubit>(context).queryController,
                  decoration: InputDecoration(
                      ...
                      hintStyle: Theme.of(context)
                          .textTheme
                          .bodyText2!
                          .copyWith(fontSize: 15, color: Colors.grey[300]))),
            ),
                    ...
                    child: SingleChildScrollView(
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final meaning = state.words[index].meanings![index];
                          final definition = meaning.definitions;
                          return ListTile(
